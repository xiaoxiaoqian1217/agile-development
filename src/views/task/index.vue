<template>
  <div class="flex h-full">
    ...
    <div class="flex flex-auto bg-gray-100">
      ...
      <!-- 这里展示动态的view -->
      <div class="flex">
        <div v-for="[type, values] in taskBoard.groupMap" :key="type">
          <div class="flex">
            <div class="py-2.5">
              <span class="mr-3 font-500">
          ...
          <div class="flex flex-col">
            <div class="mb-2" v-for="task in values" :key="task.id">
              <div>
            ...
            <div v-if="type.id === Status.new" class="w-272px">
              <div></div>
            </div>
          </div>
        </div>
...
<script setup lang="ts">
  ...
  import { UnorderedListOutlined, FilterOutlined } from '@ant-design/icons-vue';
